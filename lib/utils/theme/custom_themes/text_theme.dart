...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.normal, color: Colors.black.withAlpha(128)),
  );
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.normal, color: Colors.white.withAlpha(128)),
  );
}